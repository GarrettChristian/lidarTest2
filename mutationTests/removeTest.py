...
#     maxMax = np.linalg.norm([maxX, maxY], [0, 0])
#     maxMin = np.linalg.norm([maxX, minY], [0, 0])
#     minMax = np.linalg.norm([minX, maxY], [0, 0])
#     minMin = np.linalg.norm([minX, minY], [0, 0])

#     print("maxMax box", maxMax, [maxX, maxY])
#     print("maxMin box", maxMin, [maxX, minY])
#     print("minMax box", minMax, [minX, maxY])
#     print("minMin box", minMin, [minX, minY])
...
#     scene2 = pcdArr[labelsInstance != 212]
...
#     replaceBasedOnShadow(asset, scene2, )
